    ...
    <div class="row">
        <div class="col-md-3">
            <div class="white-box bg-inverse">
                <h3 class="box-title text-white">@lang('app.total') @lang('app.offlineRequest')</h3>
                <ul class="list-inline two-part">
                    <li><i class="icon-user text-white"></i></li>
                    <li class="text-right"><span id="totalPackages" class="counter text-white">{{ $totalRequest }}</span></li>
                </ul>
            </div>
        </div>
