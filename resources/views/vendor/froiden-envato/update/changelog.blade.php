<div class="row">
    ...
    <p>
        ...
        ├──
        │
        │   └── <strong>Version 3.4.6</strong>
        │       └── Fixed invoice link
        │       └── Fixed currency converter bug
        │       └── Fixed add product bug
        │       └── Fixed ticket date range timezone
        │
        │   └── <strong>Version 3.4.5</strong>
        │       └── Add employee bug fixed
        │
        │   └── <strong>Version 3.4.4</strong>
        │       └── Language switcher in frontend
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.3</strong>
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.2</strong>
        │       └── Ability to Mark unpaid invoices as Canceled
        │       └── Bug fixes
        │
        │   └── <strong>Version 3.4.1</strong>
        │       └── Ability to copy a contract
        │       └── Bug fixes
        │
