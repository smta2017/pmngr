                        ...
                        <div class="panel panel-default lobipanel view-task" data-task-id="{{ $task->id }}" data-sortable="true">
                            <div class="panel-body">
                                ...
                                <div class="p-t-10 p-b-10 p-10">
                                    {!!  ($task->user->image) ? '<img src="'.asset_url('avatar/'.$task->user->image).'"  data-toggle="tooltip" data-original-title="'.ucwords($task->user->name) .'" data-placement="right"
                                                            alt="user" class="img-circle" width="25" height="25" height="25">' : '<img src="'.asset('default-profile-3.png').'"  data-toggle="tooltip" data-original-title="'.ucwords($task->user->name) .'" data-placement="right"
