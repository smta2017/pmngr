                            ...
                            <div class="diff-table col-6 col-md-3">
                                ...
                                <div class="row no-gutters flex-nowrap flex-wrap overflow-x-auto row-scroll">
                                    @foreach ($packages as $key => $item)
                                        <div class="col-md-{{ (12/count($packages)) }}">
                                                ...
                                                <div class="price-top">
                                                    ...
                                                    <div class="rate">
                                                        <h2 class="mb-2"><sup>{{ $global->currency->currency_symbol }}</sup> <span
                                                                    class="font-weight-bolder">{{ round($item->annual_price) }}</span> <sub>/ @lang('modules.frontCms.perYear')</sub>
                                                        </h2>
                                            ...
                                            <div class="col-md-{{ (12/count($packages)) }}">
                                                <div class="pricing-table price-@if($key == 1)pro @endif ">
                                                    <div class="price-top">
                                                        ...
                                                        <div class="rate">
                                                            <h2 class="mb-2"><sup>{{ $global->currency->currency_symbol}}</sup> <span
                                                                        class="font-weight-bolder">{{ round($item->monthly_price) }}</span> <sub>/ @lang('modules.frontCms.perMonth')</sub>
                                                            </h2>
